...
import pandas as pd
import numpy as np
#After building the merged dataset, the next step was cleaning it. This script handles preprocessing issues such as mixed data types, missing values, and unusable columns. 
# It converts features into numeric format, removes problematic values, and saves the cleaned dataset that will be used by all later experiments
