...
import pandas as pd
import numpy as np
#Once the cleaned KAUST dataset was ready, I used this script to train the first centralized baseline models for Part 2. This code compares two different models: 
# Random Forest and MLP. 
# The goal here was to establish a strong baseline using the full KAUST dataset before moving to distributed client simulations.
