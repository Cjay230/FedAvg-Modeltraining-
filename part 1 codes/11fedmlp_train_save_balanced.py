...
#This file is the second experiment. It keeps the same federated training setup, 
# but modifies the local training data to reduce class imbalance, so I can compare the effect of balancing against the baseline FedAvg model.
import numpy as np
import pandas as pd
from sklearn.metrics import accuracy_score, precision_recall_fscore_support, confusion_matrix
from sklearn.neural_network import MLPClassifier
#so this code:\
#implements the baseline FedAvg + MLP
#loads each city as a client
#runs local client training
#aggregates weights on server
#repeats for rounds
#saves results
