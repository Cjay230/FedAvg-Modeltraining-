...
#TThis is the code that transforms the labeled city datasets into the final federated-learning input. 
#It applies the binary task definition, performs the train/test split, and saves the final train/test datasets for each client.
import pandas as pd
from sklearn.model_selection import train_test_split
from sklearn.preprocessing import MinMaxScaler
#filters the labels to car and walk (since part1 is only binary classification)
#splits each city into train/test
#prepares FL-ready datasets
#creates feature_cols.json and label_map.json
