...
import pandas as pd
#AAfter preparing the FL datasets, I saved dataset statistics such as train/test sizes and class counts per city. 
# This is the file that generated the preparation summary used in the report.
